...
Our stack is _protocol compatible_ with many projects and products - _without depending on any_. Our compatible APIs are independently developed and _fully opensource_.<br>
