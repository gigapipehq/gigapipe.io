...
<Steps>
      ...
      <Tabs>
            <Tab label="Logs">
            ⭐ Use any Loki compatible Agent <br/> 📦 
            ...
            <Tab label="Metrics">
            ⭐ Use any Prometheus compatible Agent <br/> 📦 
            [Grafana Alloy](https://grafana.com/docs/alloy/latest/), 
            [Grafana Agent](https://grafana.com/docs/agent/latest/), 
            [Vector](https://vector.dev/), 
            [Opentelemetry](https://github.com/metrico/otel-collector)
            ...
            <Tab label="Traces">
            ⭐ Use any Tempo/Zipkin compatible Agent <br/> 📦 
            [Grafana Alloy](https://grafana.com/docs/alloy/latest/), 
            [Grafana Agent](https://grafana.com/docs/agent/latest/), 
            ...
            <Tab label="Profiles">
            ⭐ Use any Pyroscope SDK compatible Agent <br/> 📦 
