...
Gigapipe provides a polyglot and robust data ingestion support across logs, metrics, traces, and profiling. With compatibility for a wide range of protocols, agents, and API. 

Gigapipe makes it simple to bring together observability data from diverse sources and vendors into a unified platform.
...
| **Agents**           | - **OpenTelemetry Collector**: Collects trace data and forwards it to qryn/Gigapipe. <br/> - **Grafana Alloy**: Collects and forwards traces to Gigapipe/qryn. <br/> - **Jaeger Agent**: Streams trace data directly to qryn-compatible destinations. |
...
|-------------------------|-----------------|
| **Protocols**           | - **Pyroscope**: Full API support for Pyroscope SDK Clients. <br> - **OpenTelemetry Profiling**: Standardized profiling format to track application resource use. |
