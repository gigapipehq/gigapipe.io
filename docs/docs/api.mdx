...
<Tabs>
            ...
            📦 [OTEL qryn](https://github.com/metrico/otel-collector/)<br/>
            </Tab>
            <Tab label="Influx">
            | **Name**             | **Type**           | **QRYN**       | **QRYN Cloud** | **APIs.**                       |   
            |----------------------|--------------------|----------------|----------------|---------------------------------|
            ...
            ⭐ Any InfluxDB v2 compatible client can be used without modifications
            ...
            | Insert (Cloudflare)  | POST               | 🟡             |🟢             | `/cf/api/v1/insert` |
            </Tab>
            <Tab label="Elastic">
            | **Name**             | **Type**           | **QRYN**      | **QRYN Cloud**| **APIs.**                   |  
            |----------------------|--------------------|---------------|---------------|-----------------------------|
