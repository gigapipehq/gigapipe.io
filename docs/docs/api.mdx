...
Gigapipe is powered by the latest version of [qryn](https://qryn.dev) and supports the following APIs
...
<Tabs>
            ...
            ##### Compatible Agents
            ⭐ Any InfluxDB v2 compatible client can be used with Gigapipe without modifications
