...
<Steps>
      ...
      <Tabs>
            ...
            The Demo ships ready with Gigapipe, Grafana, ClickHouse and everything you need!<br/>
            Batteries include configs, data generators and datasources for: 
            - Logs
            - Metrics
            - Traces
            - Profiles
      ...
      #### Configure your Observability Agents to send Logs, Metrics and Traces to Gigapipe
